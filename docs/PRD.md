...
| 🟡 | [Provider coverage](#3-provider-coverage) | Claude Code ✅; Codex ✅; OpenRouter ✅; OpenAI API 🟡; Anthropic API 🟡 (honest limits shipped; spend shown as a note — these APIs expose no quota to render as %) |
